...
double _kDatePickerPadSize = 15.w;
...
const double _kTimerPickerMinHorizontalPadding = 15;
...
const Widget _leftSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(capEndEdge: false, capStartEdge: false);
const Widget _centerSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(capEndEdge: false, capStartEdge: false);
const Widget _rightSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(capEndEdge: false, capStartEdge: false);
...
class _CupertinoDatePickerDateTimeState extends State<CustomCupertinoDatePicker> {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] = CustomCupertinoDatePicker._getColumnWidth(columnType, localizations, context);
    }
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      EdgeInsets padding = EdgeInsets.only(right: _kDatePickerPadSize);
...
class _CupertinoDatePickerDateState extends State<CustomCupertinoDatePicker> {
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] =
        CustomCupertinoDatePicker._getColumnWidth(_PickerColumnType.dayOfMonth, localizations, context);
      ...
      child: CupertinoPicker(
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          return itemPositioningBuilder(
            context,
            Text(
              localizations.datePickerDayOfMonth(month), //localizations.datePickerMonth(month)
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      if (textDirectionFactor == -1) {
        padding = EdgeInsets.only(left: _kDatePickerPadSize);
      }
      Widget selectionOverlay = _centerSelectionOverlay;
      if (i == 0) {
        selectionOverlay = _leftSelectionOverlay;
